...
const MODULES_LIST =
  import.meta.env.VITE_MODULES_LIST || 'CRM, Finance, HR, Banking, Programs, Projects, and Policies'
...
const ESCALATION_NOTICE =
  "I've flagged this conversation for our support team — someone will follow up with you by email shortly."
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          role: 'bot',
          content:
            "Sorry, I couldn't reach our support team right now. Please email success@adminie.com directly.",
        },
      ])
    } finally {
      setEscalating(false)
