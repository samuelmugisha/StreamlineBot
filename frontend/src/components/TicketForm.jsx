...
const inputCls = 'mt-0.5 w-full text-sm border border-slate-200 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-primary/30 bg-white'
const labelCls = 'text-[11px] font-medium text-slate-500 uppercase tracking-wide'

export default function TicketForm({ apiUrl, apiKey, sessionId, onBack }) {
  const [form, setForm] = useState({
    name: '', email: '', module: '', subject: '', description: '', priority: 'Medium',
  })
