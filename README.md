# adminIEBot
Customer support RAG chatbot for AdminIE

adminIE software will be used by multiple users in different parts of the world. 
Supporting many users over a large period of time can be hectic.

This project creates a RAG chatbot for AdminIE
...
2. **Customer Success-Specific Features**
...
**3. Integration & Enterprise Features**
